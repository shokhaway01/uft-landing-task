        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/3 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-8">{dict.description}</p>
            </div>
              ...
              <div className="flex flex-col gap-6 w-full md:w-1/2">
                <div className="relative rounded-3xl overflow-hidden h-1/2 group">
                  <Image
                    ...
                    className="object-cover group-hover:scale-105 transition-transform duration-700"
                  />
                  <button className="absolute bottom-6 right-6 w-10 h-10 bg-primary-dark rounded-full flex items-center justify-center text-white hover:bg-primary transition-colors z-10">
                    <FiArrowDownRight />
                  </button>
                </div>
                <div className="relative rounded-3xl overflow-hidden h-1/2 group">
